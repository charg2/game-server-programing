...
public class CircularBuffer
{
    ...
    private IntPtr space = Marshal.AllocHGlobal(100);
    private Int32 spaceSize = 100;
    ...
    unsafe public Int32 Dequeue<T>(out T dest)
    {
        ...
        Marshal.Copy(buffer, readHead, space, firstSpaceSize);
        ...
        dest = (T)Marshal.PtrToStructure(space, typeof(T));
